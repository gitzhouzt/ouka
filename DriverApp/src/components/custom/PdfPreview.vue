<template>
	<div class="pdf-preview">
		...
		<div v-if="showTools" class="page-tool">
			<div class="page-tool-item" @click="lastPage">前</div>
			<div class="page-tool-item" @click="nextPage">次</div>
			<div class="page-tool-item">{{ state.pageNum }}/{{ state.numPages }}</div>
			<div class="page-tool-item" @click="pageZoomOut">拡大</div>
