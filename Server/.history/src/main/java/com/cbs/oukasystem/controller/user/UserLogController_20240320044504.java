...
public class UserLogController {
    ...
    @Parameters(@Parameter(name = "InsertOrUpdateUserLogVO", description = "追加・編集 ユーザー", required = true))
    public ResultVO<UserLogVO> insertOrUpdate(@Validated @RequestBody IUUserLogVO iuUserLogVO) {
