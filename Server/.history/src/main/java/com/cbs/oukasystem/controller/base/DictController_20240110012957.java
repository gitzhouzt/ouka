...
public class DictController {
    ...
    @ResponseBody
    @Operation(summary = "TreeByType List - 辞典のTree")
    @PostMapping("/getTreeByType")
    public ResultVO<List<DictTreeVO>> getTreeByType(@RequestBody QueryDictVO queryVO) {
        return ResultVO.success(service.getTreeByType(queryVO));
    }
