...
public class DepositController {
    ...
    @ResponseBody
    @Operation(summary = "DepositDetail -事故情報")
    ...
    @ResponseBody
    @Operation(summary = "All Deposit - すべての事故")
    @GetMapping("/all")
    ...
    @ResponseBody
    @Operation(summary = "Deposit Page List -事故のリスト")
    @PostMapping("/list")
    ...
    @ResponseBody
    @Operation(summary = "Add/Edit Deposit - 追加・編集事故")
    @PostMapping(value = "/addOrEdit")
    @Parameters(@Parameter(name = "iuDepositVO", description = "追加・編集事故", required = true))
    ...
    @ResponseBody
    @Operation(summary = "setDeposit Car - 新規事故")
    @PostMapping(value = "/setDeposit")
    @Parameters(@Parameter(name = "iuDepositVO", description = "新規事故", required = true))
    ...
    @Parameters(@Parameter(name = "iuDepositVO", description = "設定事故金額", required = true))
    ...
    @ResponseBody
    @Operation(summary = "Delete Deposit - 削除事故")
    ...
    @ResponseBody
    @Operation(summary = "Delete Deposit - 物理削除事故")
    ...
    @ResponseBody
    @Operation(summary = "Audit Deposit - 審査事故")
    @PutMapping("/audit/{id}")
