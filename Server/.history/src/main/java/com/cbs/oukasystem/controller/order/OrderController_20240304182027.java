...
public class OrderController {
    ...
    public ResultVO<Boolean> financePays(@RequestBody SettlementVO settlementVO) {
        return ResultVO.success(service.financePays(settlementVO));
    }

    @ResponseBody
    @Operation(summary = "settlementPays 料金記録決算")
    @PostMapping("/settlementPays")
    public ResultVO<Boolean> settlementPays(@RequestBody SettlementVO settlementVO) {
        return ResultVO.success(service.settlementPays(settlementVO));
    }
