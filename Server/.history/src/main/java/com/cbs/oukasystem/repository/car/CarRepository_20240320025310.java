...
public interface CarRepository
        ...
        @Query(value = "SELECT c.car_no as carNo,c.car_type as carType, c.car_seat as carSeat,c.car_photo as carPhoto,"
                        ...
                        + " and DATE(o.start_time) = CURDATE() GROUP BY o.car_id ", nativeQuery = true)
