...
public interface UserRepository extends JpaRepository<UserEntity, String>, JpaSpecificationExecutor<UserEntity> {
        ...
        @Query(nativeQuery = true, value = "u.id,u.user_no,u.user_name,u.user_avatar,u.user_email,u.user_phone,u.user_sex,u.country_num,u.create_time,u.update_time,u.`status`,u.remark,u.is_audit,"
                        + " d.driver_license,d.driver_type,d.driver_type_code,d.license_type,d.expiry_date from user_master u  "
                        + " join user_drive d on u.id = d.user_id "
                        + " where u.is_delete = 0 "
                        + " order by u.update_time desc "
                        + " limit :page,:pageSize ")
