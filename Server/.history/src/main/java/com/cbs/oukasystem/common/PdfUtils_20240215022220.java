...
public class PdfUtils {
    ...
    public static void defaultPlacardPdfOutputStream os,
    Message message, List<String>pickVolunteers,
    Map<String, List<DictData>> allVolunteers, List<DictData>dictData)throws IOException,DocumentException
    {
