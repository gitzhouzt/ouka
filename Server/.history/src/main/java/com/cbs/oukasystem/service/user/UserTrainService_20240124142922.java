...
import org.springframework.data.jpa.domain.Specification;Train
    ...
    public Specification<UserTrainEntity> Search(QueryUserTrainVO qVo) {
        return new Specification<UserTrainEntity>() {
            ...
            public Predicate toPredicate(Root<UserTrainEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                ...
                if (null != qVo.getTrainrTypeCode() && !qVo.getTrainrTypeCode().isEmpty()) {
                    predicate.add(cb.equal(root.get("driverTypeCode"), qVo.getTrainrTypeCode()));
                }
    ...
    public UserTrainEntity insertOrUpdate(IUUserTrainVO iuVo) {
        ...
        try {
            ...
            if (null != iuVo.getId() && !iuVo.getId().isEmpty()) {
                ...
                entity.setTrainrType(iuVo.getTrainrType());
                entity.setTrainrTypeCode(iuVo.getTrainrTypeCode());
                entity.setLicenseType(iuVo.getLicenseType());
                entity.setLicenseTypeCode(iuVo.getLicenseTypeCode());
                entity.setTrainrLicense(iuVo.getTrainrLicense());
