...
public class DriverController {
    ...
    @ResponseBody
    @Operation(summary = "FFinance Order - 注文決済")
    @PutMapping(value = "/finance/{id}")
    @Parameters(@Parameter(name = "orderConfirmVO", description = "注文決済", required = true))
    public ResultVO<Boolean> finance(@PathVariable @Parameter(required = true, description = "id") String id) {
        return ResultVO.success(service.finance(id));
    }
