...
public class OrderService {
    ...
    @Autowired
    private CashItemService payItemService;
    ...
    public PayDetailsVO getPayDetails(String id) {
        ...
        // Double amount = payRecordVO.getAmount() == null ? 0 :
        // payRecordVO.getAmount();
        // if (payRecordVO.getFinanceType() == EnumFinanceType.Earnings) {
        // depositAmount += amount;
        // } else if (payRecordVO.getFinanceType() == EnumFinanceType.Advance) {
    ...
    public Boolean financePays(SettlementVO settlementVO) {
        payRecordService.settlement(settlementVO.getIds(), settlementVO.getPayMethod(), settlementVO.getPayMethodCode(),
