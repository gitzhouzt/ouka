...
public class UserRestController {
    ...
    @ResponseBody
    @Operation(summary = "UserRestDetail - 休暇情報")
    ...
    @ResponseBody
    @Operation(summary = "All UserRests - すべての休暇 ")
    @GetMapping("/all")
    ...
    @ResponseBody
    @Operation(summary = "UserRests Page List - 休暇のリスト")
    @PostMapping("/list")
    ...
    public ResultVO<UserRestVO> addOrEdit(@Validated @RequestBody IUUserRestVO iuUserRestVO) {
        return ResultVO.success(service.addOrEdit(iuUserRestVO));
    }

    @ResponseBody
    @Operation(summary = "Delete UserRest - 削除 休暇")
    ...
    @ResponseBody
    @Operation(summary = "Delete UserRest - 物理削除 休暇")
    ...
    @ResponseBody
    @Operation(summary = "Audit UserRest - 審査 休暇")
    @PutMapping("/audit/{id}")
