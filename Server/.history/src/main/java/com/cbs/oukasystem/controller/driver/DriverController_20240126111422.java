...
public class DriverController {
    ...
    @ResponseBody
    @Operation(summary = "From Car Page List -注文のリスト")
    ...
    @ResponseBody
    @Operation(summary = "todayOrder - 今日司机订单情報")
    @GetMapping("/todayOrder")
    public ResultVO<TodayVO> todayByDriver() {
        return ResultVO.success(service.getTodayOrder());
    }
