...
public class OrderService {
    ...
    public OrderEntity saveOrder(IUOrderVO iuVo) {
        ...
        try {
            ...
            iuEarningsVO.setBillingAddress(entity.getBillingAddress());
            iuEarningsVO.setStatus(EnumFinanceStatus.Waiting);
            iuEarningsVO.setStatusName(EnumFinanceStatus.Waiting.getMessage());
