...
import com.cbs.oukasystem.vo.in.order.FinancePayVO;
...
public class OrderController {
    ...
    @PostMapping("/confirmPay/{payId}")
    public ResultVO<Boolean> confirmPay(@PathVariable @Parameter(required = true, description = "id") String payId) {
        return ResultVO.success(service.confirmPay(payId));
    }

    @ResponseBody
    @Operation(summary = "financePay 料金記録精算")
    @PostMapping("/financePay/{payId}")
    public ResultVO<Boolean> financePay(@PathVariable @Parameter(required = true, description = "payId") String payId) {
        return ResultVO.success(service.financePay(payId));
    }

    @ResponseBody
    @Operation(summary = "financePays 料金記録精算")
    @PostMapping("/financePays")
    public ResultVO<Boolean> financePays(@RequestBody FinancePayVO financePayVO) {
        return ResultVO.success(service.financePays(financePayVO));
    }
