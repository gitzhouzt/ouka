...
public class DriverController {
    ...
    @ResponseBody
    @Operation(summary = "todayByDriver - 今日司机订单情報")
    @GetMapping("/todayByDriver")
    public ResultVO<DriverVO> todayByDriver() {
        return ResultVO.success(service.getTodayByDriver());
    }
