...
public class PdfUtils {
    ...
    private static final String JIEJIPAI_DEST = "jiejipai_default.pdf";
    ...
    public static void jiejipaiPdf(Map<String, Object> dataMap, String dest) throws DocumentException, IOException {

        PdfReader reader = new PdfReader(SRC + PDF_DEST + JIEJIPAI_DEST);
