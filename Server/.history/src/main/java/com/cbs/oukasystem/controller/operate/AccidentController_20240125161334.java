...
public class AccidentController {
    ...
    @ResponseBody
    @Operation(summary = "addAccident Car - 新規事故")
    @PostMapping(value = "/addAccident")
    @Parameters(@Parameter(name = "iuAccidentVO", description = "新規事故", required = true))
    public ResultVO<AccidentVO> addAccident(@Validated @RequestBody IUAccidentVO iuAccidentVO) {
        return ResultVO.success(service.addAccident(iuAccidentVO));
    }
