...
public class ScheduleService {
    ...
    // qVo.setPageSize(999);
    // int target_type = qVo.getTargetType() == EnumTargetType.Car ? 0 : 1;
    // List<Map> maps = repository.queryBySchedule(qVo.getKeyword(), target_type,
    // qVo.getWorkDate());
    // Object data = maps;
    ...
    public ListVO<ScheduleVO> getSchedule(QueryScheduleVO qVo) {
        qVo.setPageSize(999);
        int target_type = qVo.getTargetType() == EnumTargetType.Car ? 0 : 1;
        List<Map> maps = repository.queryBySchedule(qVo.getKeyword(), target_type, qVo.getWorkDate());
        Object data = maps;
        List<ScheduleVO> list = (List<ScheduleVO>) data;
        return list;
    }
    ...
    public Boolean deletePhysicsByAccidentId(String repairId, EnumTargetType targetType) {
        try {
