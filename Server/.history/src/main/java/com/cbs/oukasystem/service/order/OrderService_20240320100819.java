        ...
        if (iuVo.getFinanceType() == EnumFinanceType.OutCost) {
            switch (code) {
                ...
                earningsEntity.setEntrustSalary(earningsEntity.getEntrustSalary() + iuVo.getAmount());
                    break;
                case "有料道路":
                earningsEntity.setRoadAmount(earningsEntity.getRoadAmount() + iuVo.getAmount());
                    break;
                case "入門料":
                earningsEntity.setTicketAmount(earningsEntity.getTicketAmount() + iuVo.getAmount());
                    break;
                case "入湯税":
                earningsEntity.setBathTaxAmount(earningsEntity.getBathTaxAmount() + iuVo.getAmount());
                    break;
                case "ホテル代":
