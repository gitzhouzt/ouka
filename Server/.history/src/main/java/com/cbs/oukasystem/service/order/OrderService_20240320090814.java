...
public class OrderService {
    ...
    public PayRecordVO adminPay(IUPayRecordVO iuVo) {
        ...
        // 立替表
        if (iuVo.getFinanceType() == EnumFinanceType.InAdvance || iuVo.getFinanceType() == EnumFinanceType.OutAdvance) {
            List<AdvanceEntity> aEntities = advanceService.findByOrderNo(entity.getOrderNo());
