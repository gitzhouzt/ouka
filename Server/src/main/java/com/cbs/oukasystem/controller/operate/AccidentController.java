...
public class AccidentController {
    ...
    @ResponseBody
    @Operation(summary = "Export 事故")
    @PostMapping(value = "/export")
    @Parameters(@Parameter(name = "queryVO", description = "事故", required = true))
    public void export(@Validated @RequestBody QueryAccidentVO queryVO) {
