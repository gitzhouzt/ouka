...
public class CheckService {
    ...
    public CarCheckVO setLastCheckDate(IUCarCheckVO iuVo) {
        CarCheckEntity entity = null;
        try {
            if (null == iuVo.getId() || iuVo.getId().isEmpty()) {
            ...
            if (null != entity.getLastMonthCheckDate()) {
                ...
                } else if (null == entity.getMonthCheckDate2()) {
                    entity.setMonthCheckDate2(calendar.getTime());
                } else if (null == entity.getMonthCheckDate3()) {
        ...
        return CarCheckVOEntityMapStruct.INSTANCE.toVO(entity);
    }
    // endregion
