      ...
      <n-card :bordered="false" class="rounded-16px shadow-sm">
        <div class="flex w-full h-360px">
          <div class="w-200px h-full py-12px">
            <h3 class="text-16px font-bold dark:text-white">ダッシュボード</h3>
            <p class="text-[#aaa]"></p>
            <h3 class="pt-36px text-24px font-bold dark:text-white">
              <count-to :start-value="0" :end-value="7754" />
            </h3>
            <p class="text-[#aaa]">注文</p>
            <h3 class="pt-36px text-24px font-bold dark:text-white">
              <count-to :start-value="0" :end-value="234" />
            </h3>
            <p class="text-[#aaa]">利用者</p>
            <n-button v-if="false" class="mt-24px" type="primary">ボタン</n-button>
          </div>
