        ...
        <template #footer>
          <n-descriptions size="small" label-placement="left" bordered :column="1" :label-style="{ width: '20%' }">
            ...
            <n-descriptions-item label="ドライバー">
              <n-space class="flex items-center">
                <div class="flex items-center">
                  <span class="ml-4px">{{ props.model?.driverNo }}</span>
                </div>
                <div class="flex items-center">
                  <span class="ml-4px">{{ props.model?.driverName }}</span>
                </div>
              </n-space>
            </n-descriptions-item>
            ...
            >
            <n-descriptions-item label="詳細">
              <n-space>
                <div class="flex items-center">
                  <span class="ml-4px">{{ props.model?.details }}</span>
                </div>
              </n-space></n-descriptions-item
            >
          </n-descriptions>
...
const urls = {
  delete: '/operate/accident/delete'
};
const next = () => {
