<template>
	<n-modal v-model:show="showModalRef" :style="bodyStyleRef" transform-origin="center" :mask-closable="false"
		...
		<order-action :model="modelRef" :current="currentRef" :is-modal="true" @close="close" />
	</n-modal>
</template>
...
const modelRef = ref<MyModel.Order | null | undefined>(null);
...
const showModal = (row: MyModel.Order | null | undefined, current: number) => {
...
const titleRef = ref<string | undefined>('注文情報');
