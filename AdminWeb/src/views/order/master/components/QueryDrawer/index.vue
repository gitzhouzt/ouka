					...
					<n-grid :y-gap="2" :cols="1">
						<n-grid-item>
							...
							<n-form-item label="責任者" path="sellerName">
								<n-input-group>
									<n-input v-model:value="params.sellerName" readonly placeholder="クリック責任者を選択"
										@click="showStaff()"></n-input>
								</n-input-group>
							</n-form-item>
							<n-form-item label="ドライバー" path="driverName">
								<n-input-group>
									<n-input v-model:value="params.driverName" readonly placeholder="クリックドライバーを選択"
										@click="showDriver()"></n-input>
								</n-input-group>
							</n-form-item>
							<n-form-item label="車両" path="carNo">
								<n-input-group>
									<n-input v-model:value="params.carNo" readonly placeholder="クリック車両を選択" @click="showCar()"></n-input>
								</n-input-group>
							</n-form-item>
