	...
	<div>
		...
		<n-card size="small" class="mt-10px">
			<transition name="fade-slide" mode="out-in" appear>
				<div>
					<component :is="activeModule.component" :model="modelRef" :deploy-model="deployModelRef" @next="next"
...
import { DriverDeploy, CarDeploy, RemarkDeploy, Confirm } from './components';
