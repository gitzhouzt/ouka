				...
				<n-space :vertical="true">
					<n-form inline :label-width="100" label-placement="left">
						<n-form-item label="キーワード">
							<n-input v-model:value="searchParams.keyword" style="min-width: 30%" type="text" placeholder="表示/備考"
								clearable />
						</n-form-item>
						<n-form-item>
...
const { searchQuery, handlePageChange, searchParams, pagination, dataSource, loading, empty } =
